...
-- Inserted data from projectdata.sql
/* 
 *--------------------------------------------
...
--Display restaurant name, its address (street number and name) and telephone number.
SELECT restaurant.name, address.street_number, address.street_name, restaurant.telephone from restaurant, address;

--Best rating the restaurant ever received.
...
--Query to sort dishes by category name
...
--Query that displays all the spicy dishes, their prices and category. 

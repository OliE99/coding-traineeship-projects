...
function magic8Ball()
{
    ...
    $question = readline(">> ");
    echo "\nHmm I see... Your question is $question... I understand why this weighs heavily on you... I have consulted with the spirit world and planes beyond.\n\nHere is your answer:  \n\n";
    $answer = rand(0, 19);
    // Test Below for answer:
    //echo $answer;
    switch ($answer) {
        case 0:
            echo "It is certain.\n";

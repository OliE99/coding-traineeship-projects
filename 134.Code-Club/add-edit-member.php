...
if (!empty($_POST)) {
    ...
    if (empty($_POST['id'])) {
        ...
        try {
            ...
            $newMemberStmt = $db->prepare('INSERT INTO members (first_name, last_name, address, tier_id) VALUES (:first_name, :last_name, :address, :tier_id');
            // Execute it here
            $newMemberStmt->execute(['first_name' => $first_name, 'last_name' => $last_name, 'address' => $address, 'tier_id' => $tier_id]);
